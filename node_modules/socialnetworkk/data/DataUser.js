...
//#region CRUD
    ...
    {  
        ...
        ELSE
        BEGIN
        Update Userr Set Statee=@Statee where UserrName=@UserrName and Active=1
        select 1 as updatesuccess
        END
        `
        //  where IDCard=@IDCard";
    ...
    {  
        ...
        ELSE
        BEGIN
        Update Userr Set Visibility=@Visibility where UserrName=@UserrName and Active=1
        select 1 as updatesuccess
        END
        `
    ...
    {  
        ...
        ELSE
        BEGIN
        Update Userr Set Imagee=@Imagee where UserrName=@UserrName and Active=1
        select 1 as updatesuccess
        END
        `
    ...
    {  
        ...
        ELSE
        BEGIN
            Update Userr Set Coverphoto=@Imagee where UserrName=@UserrName and Active=1
            select 1 as updatesuccess
        END
        `
    ...
    {  
        ...
        ELSE
        BEGIN
        Update Userr Set Imagee='' where UserrName=@UserrName and Active=1
    ...
    static deleteCoverPicture=async(username)=>
        {  
            ...
            ELSE
            BEGIN
                Update Userr Set Coverphoto='' where UserrName=@UserrName and Active=1
                select 1 as deleteprofilesuccess
            END
            `
...
ocupation="",city="",country="")=>
   {
    ...
    static getUsersbyBirthDate=async(datebirth1="1700-01-01",datebirth2="2200-01-01"
    )=>
        {
                ...
                let pool = await Conection.conection();
                    const result = await pool.request()
                    .input('datebirth1', Date, datebirth1)
                    .input('datebirth2', Date, datebirth2)
                    .query(querysearch)
                for (var u of result.recordset) {
                   let userr = new DTOUser();   
                   DataUser.getinformationList(userr,u);
    ...
    static getUsersbyDateEntry=async(datebirth1="1700-01-01",datebirth2="2200-01-01"
    )=>
        {
              ...
              FROM 
                Userr 
              WHERE 
                DateEntry between @datebirth1 and @datebirth2
                AND Active = 1 
              order by 
                DateEntry desc
                       `;
