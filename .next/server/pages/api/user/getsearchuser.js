...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            const { pname , pnick , pusername , pemail , pwebsite , pocupation , pcity , pcountry  } = req.query;
            let getUsersSearchs = await socialnetworkk_data_DataUser__WEBPACK_IMPORTED_MODULE_1__.DataUser.getUsersSearchs(pname, pnick, pusername, pemail, pwebsite, pocupation, pcity, pcountry);
...
var __webpack_exports__ = __webpack_require__.X(0, [4392], () => (__webpack_exec__(950)));
