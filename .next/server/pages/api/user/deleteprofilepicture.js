...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    ...
    if (req.method === "PUT") {
        ...
        try {
            ...
            return res.status(500).send("Could not delete profile picture user: " + error1.message);
        }
    }
};
...
var __webpack_exports__ = __webpack_require__.X(0, [4392], () => (__webpack_exec__(7592)));
