...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            ...
            let getUserbyEmail = await socialnetworkk_data_DataUser__WEBPACK_IMPORTED_MODULE_1__.DataUser.getUserbyEmail(pemail);
            if (getUserbyEmail === -1) {
...
var __webpack_exports__ = __webpack_require__.X(0, [4392], () => (__webpack_exec__(7654)));
