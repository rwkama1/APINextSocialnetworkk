...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    ...
    if (req.method === "PUT") {
        ...
        try {
            const data = req.body;
            let updateStateUser = await socialnetworkk_data_DataUser__WEBPACK_IMPORTED_MODULE_0__.DataUser.updateStateUser(data.state, data.username);
            ...
            return res.status(500).send("Could not update state user: " + error1.message);
        }
    }
};
...
var __webpack_exports__ = __webpack_require__.X(0, [4392], () => (__webpack_exec__(7901)));
