...
(() => {
var exports = {};
exports.id = "pages/api/user/insertcoverpicture";
exports.ids = ["pages/api/user/insertcoverpicture"];
exports.modules = {
...
/***/ "(api)/./pages/api/user/insertcoverpicture.js":
/*!**********************************************!*\
  !*** ./pages/api/user/insertcoverpicture.js ***!
  \**********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var socialnetworkk_data_DataUser__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! socialnetworkk/data/DataUser */ \"socialnetworkk/data/DataUser\");\n/* harmony import */ var socialnetworkk_data_DataUser__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(socialnetworkk_data_DataUser__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _cors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../cors */ \"(api)/./pages/api/cors.js\");\n\n\n/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {\n    if (req.method === \"PUT\") {\n        await (0,_cors__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(req, res);\n        try {\n            const data = req.body;\n            let insertCoverPicture = await socialnetworkk_data_DataUser__WEBPACK_IMPORTED_MODULE_0__.DataUser.insertCoverPicture(data.imgcoverurl, data.username);\n            if (insertCoverPicture === -1) {\n                throw new Error(\"The user name does not exists\");\n            }\n            return res.status(200).send(\"The Cover Imagee was added successfully\");\n        } catch (error) {\n            return res.status(500).send(\"Could not insert cover picture user: \" + error.message);\n        }\n    }\n};\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/user/insertcoverpicture.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/user/insertcoverpicture.js"));
