...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            ...
            let arraydiff = [];
            let array = await socialnetworkk_data_DataSubComment__WEBPACK_IMPORTED_MODULE_0__.DataSubComment.getIfExistsSubComentsOfCommentsPost(idpost);
...
var __webpack_exports__ = __webpack_require__.X(0, [9380], () => (__webpack_exec__(1650)));
