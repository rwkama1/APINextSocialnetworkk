...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            ...
            let array = await socialnetworkk_data_DataPhoto__WEBPACK_IMPORTED_MODULE_0__.DataPhoto.getImagesByLikeUser(iduser);
...
var __webpack_exports__ = __webpack_require__.X(0, [9987], () => (__webpack_exec__(7406)));
