...
(() => {
var exports = {};
exports.id = "pages/api/message/getMessagesByUserSender";
exports.ids = ["pages/api/message/getMessagesByUserSender"];
exports.modules = {
...
/***/ "(api)/./pages/api/message/getMessagesByUserSender.js":
/*!******************************************************!*\
  !*** ./pages/api/message/getMessagesByUserSender.js ***!
  \******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* export default binding */ __WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var socialnetworkk_data_DataMessage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! socialnetworkk/data/DataMessage */ \"socialnetworkk/data/DataMessage\");\n/* harmony import */ var socialnetworkk_data_DataMessage__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(socialnetworkk_data_DataMessage__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _cors__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../cors */ \"(api)/./pages/api/cors.js\");\n\n\n/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {\n    if (req.method === \"GET\") {\n        await (0,_cors__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(req, res);\n        try {\n            let arraydiffdate = [];\n            const { iduserlogin  } = req.query;\n            let array = await socialnetworkk_data_DataMessage__WEBPACK_IMPORTED_MODULE_0__.DataMessage.getMessagesByUserSender(iduserlogin);\n            for (const message of array){\n                message.DiffDatePublishDateNow();\n                message.showDiffDatePublishDateNow();\n                arraydiffdate.push(message);\n            }\n            return res.status(200).send(arraydiffdate);\n        } catch (error) {\n            return res.status(500).send(error.message);\n        }\n    }\n};\n//# sourceURL=[module]\n//# sourceMappingURL=data:application/json;charset=utf-8;base64,\n//# sourceURL=webpack-internal:///(api)/./pages/api/message/getMessagesByUserSender.js\n");
...
var __webpack_exports__ = (__webpack_exec__("(api)/./pages/api/message/getMessagesByUserSender.js"));
