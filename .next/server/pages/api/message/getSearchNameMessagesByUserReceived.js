...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            ...
            let array = await socialnetworkk_data_DataMessage__WEBPACK_IMPORTED_MODULE_0__.DataMessage.getSearchNameMessagesByUserReceived(iduserlogin, name);
...
var __webpack_exports__ = __webpack_require__.X(0, [5390], () => (__webpack_exec__(5171)));
