...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            let getsAlbumImages = await socialnetworkk_data_DataAlbumImage__WEBPACK_IMPORTED_MODULE_0__.DataAlbumImages.getsAlbumImages();
            return res.status(200).send(getsAlbumImages);
        } catch (error) {
...
var __webpack_exports__ = __webpack_require__.X(0, [5427], () => (__webpack_exec__(6644)));
