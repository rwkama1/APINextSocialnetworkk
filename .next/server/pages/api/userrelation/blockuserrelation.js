...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    ...
    if (req.method === "PUT") {
        ...
        try {
            const data = req.body;
            let blockFriend = await socialnetworkk_data_DataUserRelation__WEBPACK_IMPORTED_MODULE_1__.DataUserRelation.blockFriend(data.iduser, data.idfriend);
            if (blockFriend === -1) {
...
var __webpack_exports__ = __webpack_require__.X(0, [4877], () => (__webpack_exec__(5354)));
