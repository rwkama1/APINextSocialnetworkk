...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            ...
            let getFriendsOfFriendsUser = await socialnetworkk_data_DataUserRelation__WEBPACK_IMPORTED_MODULE_0__.DataUserRelation.getFriendsOfFriendsUser(piduser);
...
var __webpack_exports__ = __webpack_require__.X(0, [4877], () => (__webpack_exec__(6699)));
