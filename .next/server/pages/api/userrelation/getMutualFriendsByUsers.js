...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            ...
            let getMutualFriendsByUsers = await socialnetworkk_data_DataUserRelation__WEBPACK_IMPORTED_MODULE_0__.DataUserRelation.getMutualFriendsByUsers(piduserlogin, piduser2);
...
var __webpack_exports__ = __webpack_require__.X(0, [4877], () => (__webpack_exec__(5525)));
