...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(req, res) {
    if (req.method === "GET") {
        ...
        try {
            ...
            let array = await socialnetworkk_data_DataVideo__WEBPACK_IMPORTED_MODULE_0__.DataVideo.getVideosVisibilityFriendUser(iduser);
...
var __webpack_exports__ = __webpack_require__.X(0, [4372], () => (__webpack_exec__(6597)));
